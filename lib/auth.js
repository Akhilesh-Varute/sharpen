...
// characters match, which matters for a 4-8 digit PIN that's otherwise
// unthrottled. This runs in both Node and Edge, so it can't use Node's
// crypto.timingSafeEqual -- a manual constant-time compare works in both.
...
export function checkPin(candidate) {
  ...
  return timingSafeEqualStr(candidate, pin);
}
